...
<a href="<?php echo esc_url( home_url( '/') ); ?>" class="c-page-top__link" id="js-page-top">
...
<a href="<?php echo esc_url( home_url('contact')); ?>" class="c-contact-btn__link" id="js-contact-btn">
